...
public class HttpClientUtils {
	...
	public static String post(String url, String body) throws Exception {
		...
		if (StringUtils.isNotBlank(url) && StringUtils.isNotBlank(body)) {
			...
			try {
				...
				throw new InvalidCustomException("发送HttpClient Post请示失败！", e);
			} finally {
	 ...
	 * @throws IOException
	 */
	public static String get(String url) throws InvalidCustomException {
		String result = "";
		if (StringUtils.isNotBlank(url)) {
			...
			try {
				...
				throw new InvalidCustomException("发送HttpClient Get请示失败！", e);
			}finally {
	 ...
	 * @throws IOException
	 */
	public static String put(String url) throws InvalidCustomException {
		String result = "";
		if (StringUtils.isNotBlank(url)) {
			...
			try {
				...
				throw new InvalidCustomException("发送HttpClient Put请示失败！", e);
			}finally {
